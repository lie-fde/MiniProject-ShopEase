...
import {CiLocationOn,CiLogout,CiLogin} from 'react-icons/ci'
...
const Mainsite = () => {
  ...
  return (
    ...
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <Link to="/Login"> <button className='bg-black text-white  items-center py-1 rounded-full w-20 hidden sm:inline'>
        SignIN
      </button></Link>
