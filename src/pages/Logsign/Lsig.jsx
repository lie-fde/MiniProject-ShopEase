  ...
  return (
    ...
    <div>
        <div className='bg-slate-800 border-slate-400 roundeed-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
            ...
            <button className='w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-gray-800 hover:bg-gray-600 hover:text-white py-2 transition-colors duration-300' type="submit">Login</button>
            <div>
                <span className='mt-4'>New Here? <Link className='text-blue-500' to='/Signup'>Create an Account</Link> </span>
            </div>
            </form>
        </div>
    </div>
